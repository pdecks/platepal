"""Utility file to seed Yelp tables from Yelp Academic Dataset in data/yelp/"""
import json
...
if __name__ == "__main__":
    ...
    # ONLY RUN TO INITIALLY SEED THE YELP DATABASES!
    # RE-RUNNING WILL DELETE EXISTING DATA.
    # load_yelp_biz(bdf)
    # load_yelp_users(udf)
